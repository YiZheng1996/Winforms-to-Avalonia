...
- [ ] 冻结旧 WinForms 的发布版本并建立可恢复标签/分支；当前已建立 `main` 提交基线，但尚未建立 Legacy freeze 标签/分支。
...
5. 形成可追踪的 Git 提交/分支基线。该项已具备：远端 `main` 当前为 `bebcb9e1858e35e10ca395e3b7e824c724286524`，并已完成独立 clone 复现；其余现场和产品条件仍未满足。
